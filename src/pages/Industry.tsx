      ...
      <section className="industry-page-section">
        <div className="industry-page-container">
          ...
          <div className="cta-section">
            ...
            <p className="cta-subtitle">Discover how BizSuite can be tailored to fit your unique needs.</p>
            <a href="/contact-sales" className="btn btn-primary cta-button">Get Started</a>
          </div>
        </div>
      </section>
    </main>
